...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row mb-3">
                            <label for="checkbox" class="col-md-4 col-form-label text-md-end"><?php echo e(__('Соглашение с правилами')); ?> </label>

                            <div class="col-md-6">
                            <input type="checkbox" id="rules" name="interest" value="rules" required/>
                            </div>
                        </div>
